...
@handler = ($,data)=>
  ...
  if boo
    ...
    yield _invoke db, 'update',{account:$.user.id},{$set:{phone: [data.mobile_phone, data.extra_phone], email:[data.post], social_networks: {skype:[data.skype]}, site:[data.site]}},{upsert:true}
