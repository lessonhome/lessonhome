...
#        training_direction: items: filter.course
        ...
        rules_sync : {
          ...
          'английский язык':[0, 1, 2, 3, 4, 5]
          'высшая математика':[4, 5]
          'инженерная графика':[4, 5]
          'компьютерная графика':[3, 4, 5]
          'логика':[2, 3, 4, 5]
          'математический анализ':[4, 5]
          'начертательная геометрия':[4, 5]
          'программированрие':[3, 4, 5]
          'сопромат':[4, 5]
          'статистика':[4, 5]
          'теоретическая механика':[4, 5]
          'черчение':[4, 5]
          'чисельные методы':[4, 5]
          'электротехника':[4, 5]
          'журналистика':[4, 5]
          'культурология':[4, 5]
          'менеджмент':[4, 5]
          ...
          'экономика':[4, 5]
          'латынь':[4, 5]
          'компьютерная грамотность' : [2, 3, 4, 5]
        }
        price_select:
          items: filter.price
        status_tutor:
