...
class @main extends @template 'lp/all'
  route : '/repetitory-istoriya-starshie-klassy'
  #tags  : -> ['registration']
  model : 'main/registration'
  title : "Репетиторы по истории старшая школа"
  tree : =>
    photo_src         : 'reclame_jump_page/land_history.jpg'
    alt               : 'Репетиторы по истории старшая школа'
    ...
    title_suit_tutors : 'Репетиторы по истории:<br><small>подготовка к ЕГЭ, экзаменам и олимпиадам</small>'
