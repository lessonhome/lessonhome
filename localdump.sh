...
rsync -azv --delete /home/dump/data/latest/images ./www/lessonhome/static/user_data
rsync -azv --delete /home/dump/data/latest/urldata ./www/lessonhome/static/
mkdir -p .cache
rsync -azv --delete /home/dump/data/latest/mongo .cache/
