(function() {
  ...
  Tutors = (function() {
    function Tutors() {
      ...
      this.jobGetTutor = bind(this.jobGetTutor, this);
    ...
    Tutors.prototype.init = function*() {
      ...
      this.jobs.listen('filterTutors', this.jobFilterTutors);
      this.jobs.listen('getTutor', this.jobGetTutor);
    ...
    Tutors.prototype.jobFilterTutors = function(arg) {
      var count, exists, filter, from, preps;
    ...
    Tutors.prototype.jobGetTutor = function(arg) {
      var index, ref;
      index = arg.index;
      return (ref = this.index[index]) != null ? ref : this.index[99637];
    };
    ...
    Tutors.prototype.reload = function() {
      return $W(_reload.reload).apply(this);
    };
